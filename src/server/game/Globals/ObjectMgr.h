...
#define MIN_DARKCORE_STRING_ID           1
#define MAX_DARKCORE_STRING_ID           2000000000
#define MIN_DB_SCRIPT_STRING_ID        MAX_DARKCORE_STRING_ID
...
class ObjectMgr
{
    ...
    public:
        ...
        bool LoadCoreStrings() { return LoadCoreStrings("core_string", MIN_DARKCORE_STRING_ID, MAX_DARKCORE_STRING_ID); }
        ...
        {
            DARKCORE_GUARD(ACE_Thread_Mutex, m_CreatureRespawnTimesMtx);
        ...
        {
            DARKCORE_GUARD(ACE_Thread_Mutex, m_GORespawnTimesMtx);
